...
- Data is passed from parent to child using props. Then the child sends data back to the parent by executing a callback function provided through those same props.
